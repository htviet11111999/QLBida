...
public class ThayDoiMK extends Fragment {
    TaiKhoan tk;
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.thaydoimatkhau,container, false);
        EditText mkcu = (EditText) view.findViewById(R.id.inputMKmuondoi);
        EditText mkmoi = (EditText) view.findViewById(R.id.inputMK);
        EditText mkmoixacthuc = (EditText) view.findViewById(R.id.inputMKXacThuc);
        Button hoanthanh = (Button) view.findViewById(R.id.btnHoanThanh);
