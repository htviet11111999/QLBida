...
public class AdapterCTPN extends ArrayAdapter<CTPhieuNhap> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ((TextView) convertView.findViewById(R.id.tenvatpham_ctpn)).setText(String.format("Tên vật phẩm : %s", ct.getTenvatpham()));
        ((TextView) convertView.findViewById(R.id.soluong_ctpn)).setText(String.format("Số lượng : %s", ct.getSoluong()));
        ((TextView) convertView.findViewById(R.id.dongia_ctpn)).setText(String.format("Đơn giá : %s", ct.getDongia()));
        return convertView;
    }
