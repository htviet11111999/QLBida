...
public class ThongTinTK extends Fragment {
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.thongtintaikhoan_cuachutiem,container, false);
        ImageView img_avatar = (ImageView) view.findViewById(R.id.avatar_qltkct);
        TextView tv_hoten = (TextView) view.findViewById(R.id.hoten_chitietQltkct);
        TextView tv_sdt = (TextView) view.findViewById(R.id.sdt_chitietQltkct);
        TextView tv_diachi = (TextView) view.findViewById(R.id.diachi_chitietQltkct);
        TextView tv_quyen = (TextView) view.findViewById(R.id.quyen_chitietQltkct);
        Button btn_sua = (Button) view.findViewById(R.id.sua_qltkct);
        ApiService.apiService.lay1TaiKhoan(Menu_CT.machutiem)
        ...
        btn_sua.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getActivity(), SuaTTTK.class);
                intent.putExtra("id",Menu_CT.machutiem);
